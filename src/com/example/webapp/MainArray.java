...
/**
 * Interactive test for com.example.webapp.storage.ArrayStorage implementation
...
public class MainArray {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Resume r;
        while (true) {
            System.out.print("Введите одну из команд - (list | size | save full name | delete uuid |update uuid full name| get uuid | clear | exit): ");
